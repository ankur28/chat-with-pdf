...
export default function Home() {
  return (
    <main className="flex-1 overflow-scroll p-2 lg:p-5 bg-gradient-to-bl from-white to-indigo-500text-indigo-500">
      <div className="bg-white py-24 sm:py-32 rounded-md drop-shadow-xl">
        <div className="flex flex-col justify-center items-center mx-auto max-w-7xl px-6 lg:px-8">          
          <div className="mx-auto max-w-2xl sm:text-center">
            <h2 className="text-base font-semibold leading-7 text-indigo-500">Your Interactive Document Companion</h2>
            ...
            <p className=" mt-6 text-lg leading-8 text-[#535353]">
              ...
              everyone,<span className="text-indigo-500"> Chat with PDF</span>{" "}
