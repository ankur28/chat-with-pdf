...
export default function Home() {
  return (
    <main className="flex-1 overflow-scroll p-2 lg:p-5 bg-gradient-to-bl from-white to-indigo">
      <div className="bg-white py-24 sm:py-32 rounded-md drop-shadow-xl">
        <div className="flex flex-col justify-center items-center mx-auto max-w-7xl px-6 lg:px-8">          
          <div className="mx-auto max-w-2xl sm:text-center">
            <h2 className="text-base font-semibold leading-7 text-indigo">Your Interactive Document Companion</h2>
        ...
        <div>
          <div>
            <Image
              ...
              width={2432}
              height={1442}
              className="mb-[-0%] mt-10 rounded-xl shadow-2xl ring-1 ring-gray-900/10"
            ></Image>
          </div>
        </div>
      </div>
